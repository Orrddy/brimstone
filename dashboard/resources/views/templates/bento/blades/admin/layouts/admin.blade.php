...
<body
        ...
        <div class="p-4 border-t border-white/5 bg-secondary-dark/30">
            <div class="flex items-center gap-3 p-3 rounded-xl bg-white/5 border border-white/5">
                ...
                @if (Auth::guard('admin')->user()->image)
                    <div
                        class="h-10 w-10 rounded-lg bg-gradient-to-br from-[#0a1628] to-[#1a2744] border border-[#c9a84c]/30 flex items-center justify-center text-white font-bold text-lg shadow-inner">
                        <img src="{{ asset('storage/profile/' . Auth::guard('admin')->user()->image) }}"
                            alt="{{ Auth::guard('admin')->user()->name }}" class="w-full h-full object-cover">
                    </div>
                @else
                    <div
                        class="h-10 w-10 rounded-lg bg-gradient-to-br from-[#0a1628] to-[#1a2744] border border-[#c9a84c]/30 flex items-center justify-center text-[#c9a84c] font-bold text-lg shadow-inner">
    ...
    <div class="flex-1 flex flex-col min-w-0 h-screen overflow-hidden bg-primary-dark relative">
            ...
            <div class="flex items-center gap-3">
                ...
                <div class="relative">
                    <button onclick="toggleDropdown('mobile-header-profile-menu')"
                        class="w-8 h-8 rounded-full overflow-hidden bg-gradient-to-br from-[#0a1628] to-[#1a2744] border border-[#c9a84c]/30 flex items-center justify-center text-[#c9a84c] font-bold text-xs shadow-inner ring-2 ring-transparent hover:ring-[#c9a84c]/20 transition-all">
                        @if (Auth::guard('admin')->user()->image)
                            <img src="{{ asset('storage/profile/' . Auth::guard('admin')->user()->image) }}"
                                alt="{{ Auth::guard('admin')->user()->name }}" class="w-full h-full object-cover">
                        @else
            ...
            <div class="flex items-center gap-6">
                ...
                <div class="relative group">
                    <button
                        ...
                        <div
                            class="h-8 w-8 rounded-full overflow-hidden bg-gradient-to-br from-[#0a1628] to-[#1a2744] border border-[#c9a84c]/30 flex items-center justify-center text-[#c9a84c] font-bold text-xs shadow-inner">
                            @if (Auth::guard('admin')->user()->image)
                                <img src="{{ asset('storage/profile/' . Auth::guard('admin')->user()->image) }}"
        ...
        <div class="fixed inset-0 z-0 overflow-hidden pointer-events-none">
            <div class="absolute top-0 left-1/4 w-96 h-96 rounded-full blur-3xl" style="background: rgba(201, 168, 76, 0.04);"></div>
            <div class="absolute bottom-0 right-1/4 w-96 h-96 rounded-full blur-3xl" style="background: rgba(10, 22, 40, 0.8);"></div>
        </div>
